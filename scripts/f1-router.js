...
const handleAllCircuits = (app) => {
    app.get('https://w2024-assign1-8plk.onrender.com/api/circuits', async (req, res) => {
        const {data, error} = await supabase
        .from('circuits')
        .select();
...
const handleCircuit = (app) => {
    app.get('https://w2024-assign1-8plk.onrender.com/api/circuits/:ref', async (req, res) => {
        const {data, error} = await supabase
        .from('circuits')
        .select()
...
const handleAllCircuitsInSeason = (app) => {
    app.get('https://w2024-assign1-8plk.onrender.com/api/circuits/seasons/:year', async (req, res) => {
        const {data, error} = await supabase
        .from('races')
...
const handleAllConstructors = (app) => {
    app.get('https://w2024-assign1-8plk.onrender.com/api/constructors', async (req, res) => {
        const {data, error} = await supabase
        .from('constructors')
        .select();
...
const handleConstructor = (app) => {
    app.get('https://w2024-assign1-8plk.onrender.com/api/constructors/:ref', async (req, res) => {
        const {data, error} = await supabase
        .from('constructors')
        .select()
...
const handleAllDrivers = (app) => {
    app.get('https://w2024-assign1-8plk.onrender.com/api/drivers', async (req, res) => {
        const {data, error} = await supabase
        .from('drivers')
        .select();
...
const handleDriver = (app) => {
    app.get('https://w2024-assign1-8plk.onrender.com/api/drivers/:ref', async (req, res) => {
        const {data, error} = await supabase
        .from('drivers')
        .select()
...
const handleDriversWithPrefix = (app) => {
    app.get('https://w2024-assign1-8plk.onrender.com/api/drivers/search/:substring', async (req, res) => {
        const {data, error} = await supabase
        .from('drivers')
        .select()
...
const handleDriversInRace = (app) => {
    app.get('https://w2024-assign1-8plk.onrender.com/api/drivers/race/:raceId', async (req, res) => {
        const {data, error} = await supabase
        .from('results')
...
const handleRace = (app) => {
    app.get('https://w2024-assign1-8plk.onrender.com/api/races/:raceId', async (req, res) => {
        const {data, error} = await supabase
        .from('races')
...
const handleRacesInSeason = (app) => {
    app.get('https://w2024-assign1-8plk.onrender.com/api/races/season/:year', async (req, res) => {
        const {data, error} = await supabase
        .from('races')
...
const handleNthRaceInSeason = (app) => {
    app.get('https://w2024-assign1-8plk.onrender.com/api/races/season/:year/:round', async (req, res) => {
        const {data, error} = await supabase
        .from('races')
        .select('*, seasons!inner (*)')
        .eq('seasons.year', req.params.year)
...
const handleRacesInCircuit = (app) => {
    app.get('https://w2024-assign1-8plk.onrender.com/api/races/circuits/:ref', async (req, res) => {
        const {data, error} = await supabase
        .from('races')
        .select(`name, year, circuits!inner (name, location, country)`)
...
const handleRacesInCircuitBetween = (app) => {
    app.get('https://w2024-assign1-8plk.onrender.com/api/races/circuits/:ref/season/:start/:end', async (req, res) => {
        const {data, error} = await supabase
        .from('races')
        .select(`name, year, circuits!inner (name, location, country)`)
        .eq('circuits.circuitRef', req.params.ref)
...
const handleResultsforRace = (app) => {
    app.get('https://w2024-assign1-8plk.onrender.com/api/results/:raceId', async (req, res) => {
        const {data, error} = await supabase
        .from('results')
...
const handleDriverResults = (app) => {
    app.get('https://w2024-assign1-8plk.onrender.com/api/results/driver/:ref', async (req, res) => {
        const {data, error} = await supabase
        .from('results')
...
const handleDriverResultsBetween = (app) => {
    app.get('https://w2024-assign1-8plk.onrender.com/api/results/driver/:ref/seasons/:start/:end', async (req, res) => {
        const {data, error} = await supabase
        .from('results')
...
const handleRaceQualResults = (app) => {
    app.get('https://w2024-assign1-8plk.onrender.com/api/qualifying/:raceId', async (req, res) => {
        const {data, error} = await supabase
        .from('qualifying')
        .select(`drivers!inner (driverRef, code, forename, surname), races!inner (name, round, year, date), constructors!inner (name, constructorRef, nationality)`)
        .eq('races.raceId', req.params.raceId)
...
const handleSeasonStandings = (app) => {
    app.get('https://w2024-assign1-8plk.onrender.com/api/standings/:raceId/drivers', async (req, res) => {
        const {data, error} = await supabase
...
const handleConstructorStandings = (app) => {
    app.get('https://w2024-assign1-8plk.onrender.com/api/standings/:raceId/constructors', async (req, res) => {
        const {data, error} = await supabase
